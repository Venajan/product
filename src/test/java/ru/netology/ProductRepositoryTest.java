...
public class ProductRepositoryTest {
    ...
    Product product2 = new Product(2, "Product 2", 2_000);
    Product product3 = new Product(3, "Product 3", 40_000);
    Product product4 = new Product(4, "Product 4", 100_000);
    Product product5 = new Product(5, "Product 5", 300);
    Product product6 = new Product(6, "Product 6", 19_500);
    ...
    public void shouldAddProduct() {
        Product newProduct = new Product(7, "New Product", 6_000);
        repo.add(newProduct);
